...
const vehicleStatusModal   = document.getElementById('vehicle-status-modal');          // era: popup-vehicle-status
const vehicleStatusTitle   = document.getElementById('vehicle-status-modal-title');    // era: popup-vehicle-title
const vehicleStatusSelect  = document.getElementById('vehicle-status-select');         // manteve-se
const vehicleStatusOkBtn   = document.getElementById('vehicle-status-ok-btn');         // era: popup-vehicle-ok-btn
const vehicleStatusCancelBtn = document.getElementById('vehicle-status-cancel-btn');   // era: popup-vehicle-cancel-btn
