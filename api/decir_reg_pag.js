    ...
    export default async function handler(req, res) {
      ...
      try {
        ...
        // ---------- OCORRÊNCIAS ----------
          ...
          const MONTH_COLS = {"Maio": {occ: "B", date: "C", act: "D"}, "Junho": {occ: "E", date: "F", act: "G"}, "Julho": {occ: "H", date: "I", act: "J"}, "Agosto": {occ: "K", date: "L", act: "M"},
                              "Setembro": {occ: "N", date: "O", act: "P"}, "Outubro": {occ: "Q", date: "R", act: "S"}};
          const START_ROW = 7;
