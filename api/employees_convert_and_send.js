import ExcelJS from "exceljs";
  ...
  try {
    ...
    ws.addConditionalFormatting({
      ...
      rules: [
        { type: "containsText", operator: "containsText", text: "OK", style: { font: { bold: true, color: { argb: "FF10B981" } } } },
        { type: "containsText", operator: "containsText", text: "Verificação", style: { font: { bold: true, color: { argb: "FFEF4444" } } } }
      ]
    });
