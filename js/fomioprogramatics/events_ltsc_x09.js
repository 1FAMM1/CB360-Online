      ...
      try {
        ...
        try {
          ...
          if (activeUsers.length > 0) {
            ...
            const notifications = activeUsers.map(u => ({n_int: u.n_int, corp_oper_nr: corp_oper_nr, title: "EVENTOS", message: `📢 Novo evento: "${eventName}". Inscrições abertas na área de eventos!`,
            ...
            try {
              await fetch('https://cb-360-app.vercel.app/api/sendPush', {
                ...
                body: JSON.stringify({recipient_nint: 'geral', corp_nr: corp_oper_nr, sender_name: 'CB360 Online', message_text: `📢 Novo evento: "${eventName}". Inscrições abertas!`, 
                                      sender_nint: '0'})
              });
