      ...
      const htmlTemplate = `
        ...
        <head>
          ...
          <style>
            ...
            .message-box { background-color: #f8fafc; border-left: 4px solid #d81c1c; padding: 0px 20px; margin: 5px 0 25px 0; border-radius: 0 6px 6px 0; white-space: pre-line; color: #1e293b; font-size: 14.5px; }
